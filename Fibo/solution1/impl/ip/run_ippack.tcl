...
set Library     "hls"
set IPName      "fibonacci"
set Version     "1.0"
set DisplayName "Fibonacci"
set Revision    "2113384567"
...
set sdx_kernel_name "fibonacci"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/ap576391/Documents/Hermann/Fibo/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {fibonacci_AXILiteS_s_axi
fibonacci
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 entre W 0x0 "Data signal of entre" {{0 32 entre W 0 "Bit 31 to 0 Data signal of entre"}}} {0x18 sortie R 0x0 "Data signal of sortie" {{0 32 sortie R 0 "Bit 31 to 0 Data signal of sortie"}}} {0x1c sortie_ctrl R 0x0 "Control signal of sortie" {{0 1 sortie_ap_vld R 0 "Control signal sortie_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
