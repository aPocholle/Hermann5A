...
HD_PWD='C:/Users/ap576391/Documents/Hermann/EXP32/EXP32.runs/system_PmodESP32_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_PmodESP32_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_PmodESP32_0_0.tcl
