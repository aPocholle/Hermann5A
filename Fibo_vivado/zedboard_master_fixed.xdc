...
set_property PACKAGE_PIN Y8  [get_ports {SDATA_O_0}];  # "AC-GPIO0"
set_property PACKAGE_PIN AA7 [get_ports {SDATA_I_0}];  # "AC-GPIO1"
set_property PACKAGE_PIN AA6 [get_ports {BCLK_0}];  # "AC-GPIO2"
set_property PACKAGE_PIN Y6  [get_ports {LRCLK_0}];  # "AC-GPIO3"
set_property PACKAGE_PIN AB2 [get_ports {FCLK_CLK1_0}];  # "AC-MCLK"
set_property PACKAGE_PIN AB4 [get_ports {IIC_1_0_scl_io}];  # "AC-SCK"
set_property PACKAGE_PIN AB5 [get_ports {IIC_1_0_sda_io}];  # "AC-SDA"
# ----------------------------------------------------------------------------
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {GPIO_0_tri_o[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {GPIO_0_tri_o[1]}];  # "LD1"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {GPIO2_0_tri_i}];  # "SW0"
