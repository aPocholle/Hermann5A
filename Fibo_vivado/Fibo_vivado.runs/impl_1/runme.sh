...
HD_PWD='C:/Users/ap576391/Documents/Hermann/Fibo_vivado/Fibo_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log systeme_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source systeme_wrapper.tcl -notrace
