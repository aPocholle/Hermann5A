...
HD_PWD='C:/Users/ap576391/Documents/Hermann/Fibo_vivado/Fibo_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systeme_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systeme_wrapper.tcl
